...
public class GjeneroAddPdf {
	...
	public String gjeneroAddPdf(Dega dega) throws ParseException, IOException, NoSuchProviderException {
        ...
        headerParagraf.add("Shtimi i Degës "+dega.getDega()+" nga "+emriAdmin);//statement
        }else {
        	 headerParagraf.add("Shtimi i Degës "+dega.getDega()+" nga "+this.getEmriMbiemri(user));//statement
        }
